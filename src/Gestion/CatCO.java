...
public class CatCO extends javax.swing.JFrame {

    /**
     * Creates new form CatCO
     */
    public CatCO() {
        initComponents();
        FillTable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CatCO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
